...
export default {
  ...
  async mounted() {
    this.listar();
    const totales = await axios.get('https://activosfijos.emi.edu.bo/escritorio/grafica1');
    ...
    const auxiliares = await axios.get('https://activosfijos.emi.edu.bo/escritorio/grafica2');
